...
Because this project is about resolving disputes, we hold an extra line: do not
use the project, its issues, or its discussions to coordinate harassment,
threats, blackmail, doxxing, forged evidence, or fraud against anyone. That
contradicts the project's safety policy and is not tolerated.
...
reports, through the private channel described in [SECURITY.md](SECURITY.md).
