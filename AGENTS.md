...
Codex can read skills from `.agents/skills/` or the repo `skills/` directory. Use `saul install --host <claude-code|codex|openclaw>` to copy skills into the expected location for each host.
